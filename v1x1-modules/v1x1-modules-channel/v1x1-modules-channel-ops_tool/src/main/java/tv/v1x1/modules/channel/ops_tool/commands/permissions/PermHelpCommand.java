 ...
 * @author Josh
 */
public class PermHelpCommand extends Command {
    final private OpsTool opsTool;
    final private CommandDelegator masterDelegator;

    public PermHelpCommand(final OpsTool opsTool, final CommandDelegator delegator) {
    ...
    public void run(final ChatMessage chatMessage, final String command, final List<String> args) {
        opsTool.respond(chatMessage.getChannel(), GenericHelpMessage.helpMessage(masterDelegator, (args.size() > 0 ? args.get(0) : ""), "!ot p "));
    }
}
