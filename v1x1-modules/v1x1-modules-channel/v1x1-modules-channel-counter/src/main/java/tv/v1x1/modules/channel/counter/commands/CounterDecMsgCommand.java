 ...
 */
public class CounterDecMsgCommand extends Command {
    final private CounterModule module;

    public CounterDecMsgCommand(final CounterModule module) {
        this.module = module;
    }

    @Override
    public List<String> getCommands() {
        return ImmutableList.of("decmsg");
    }
    ...
    public String getDescription() {
        return "Set the message when someone decrements the counter";
    }

    @Override
    public String getHelp() {
        return "If geek mode is enabled, you can subtractone with just \"counter--\"";
    }
    ...
    public void run(final ChatMessage chatMessage, final String command, final List<String> args) {
        ...
        counter.setDecMessage(String.join(" ", args));
