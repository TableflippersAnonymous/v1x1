...
public class FactListCommand extends Command {
    ...
    private void handleAlias(final Factoid factoid, final HashMap<String, List<String>> aliasMap) {
        LOG.debug("handleAlias() {} -> {}", factoid.getId(), factoid.getData());
        final String aliasName = factoid.getId();
        final String aliasTarget = factoid.getData();
    ...
    private void handleFact(final Factoid factoid, final HashMap<String, List<String>> aliasMap) {
        aliasMap.putIfAbsent(factoid.getId(), new ArrayList<String>());
    }
