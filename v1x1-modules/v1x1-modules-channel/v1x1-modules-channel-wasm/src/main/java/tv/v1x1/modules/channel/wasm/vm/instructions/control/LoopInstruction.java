...
public class LoopInstruction extends Instruction {
    ...
    public void validate(final WebAssemblyValidationStack stack, final Context context) throws ValidationException {
        ...
        stack.pushControl(ImmutableList.of(), list);
        final Context newContext = context.addLabel(new ResultType(ImmutableList.of()));
        validateSequence(stack, newContext, innerInstructions);
    }

    @Override
    public void execute(final WebAssemblyVirtualMachine virtualMachine) throws TrapException {
        enter(virtualMachine, new Label(this, 0, this, nextInstruction), innerInstructions);
    }
}
