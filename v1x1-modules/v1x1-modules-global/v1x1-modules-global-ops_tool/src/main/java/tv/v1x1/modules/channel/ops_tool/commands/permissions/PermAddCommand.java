 ...
 * @author Josh
 */
public class PermAddCommand extends Command {
    final private OpsTool opsTool;

    public PermAddCommand(final OpsTool opsTool) {
        this.opsTool = opsTool;
    }

    @Override
    public List<String> getCommands() {
        return ImmutableList.of("mkperm", "addperm", "mkperms", "addperms");
    }
    ...
    public void run(final ChatMessage chatMessage, final String command, final List<String> args) {
        ...
        if(opsTool.addPerm(tenant, groupName, permission)) {
            opsTool.respond(channel, "Perms added");
        } else {
