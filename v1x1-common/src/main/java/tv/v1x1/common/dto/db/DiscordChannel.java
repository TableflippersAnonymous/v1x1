...
public class DiscordChannel extends Channel {
    ...
    @Override
    public tv.v1x1.common.dto.core.DiscordChannel toCore(final TenantAccessor accessor) {
        return new tv.v1x1.common.dto.core.DiscordChannel(getId(), accessor.getById(getTenantId()).toCore(), getDisplayName());
    }
}
