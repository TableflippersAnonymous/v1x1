...
public class NoticeCommand extends IrcStanza {
    ...
    public enum MessageId {
        ...
        UNRECOGNIZED_COMMAND, MSG_DUPLICATE, MSG_RATELIMIT, BAD_TIMEOUT_BROADCASTER,
        BAD_TIMEOUT_MOD, HOST_TARGET_WENT_OFFLINE, NO_PERMISSION, FOLLOWERS_OFF, FOLLOWERS_ON
    }
