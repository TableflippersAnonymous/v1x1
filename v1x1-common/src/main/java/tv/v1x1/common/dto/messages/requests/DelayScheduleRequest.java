...
public class DelayScheduleRequest extends ScheduleRequest {
    ...
    public static DelayScheduleRequest fromProto(final Module module, final UUID uuid, final long timestamp, final String responseQueueName, final UUID scheduleId, final byte[] payload, final RequestOuterClass.ScheduleRequest proto) {
        final long delay = proto.getDelay();
        return new DelayScheduleRequest(module, uuid, timestamp, responseQueueName, scheduleId, payload, delay);
    }
    ...
    public DelayScheduleRequest(final Module from, final UUID messageId, final long timestamp, final String responseQueueName, final UUID scheduleId, final byte[] payload, final long delay) {
