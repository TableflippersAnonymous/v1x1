...
public class TwitchChannel extends Channel {
    ...
    @Override
    public tv.v1x1.common.dto.core.TwitchChannel toCore(final TenantAccessor accessor) {
        return new tv.v1x1.common.dto.core.TwitchChannel(getId(), accessor.getById(getTenantId()).toCore(), getDisplayName());
    }
}
